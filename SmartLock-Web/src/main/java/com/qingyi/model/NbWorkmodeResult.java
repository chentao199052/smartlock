...
public class NbWorkmodeResult {
	...
	public NbWorkmodeResult() {
		super();
		// TODO Auto-generated constructor stub
	}
	public NbWorkmodeResult(String itid, String roomtxtype, String status, String roomcode2, String osdate,
			String order) {
		super();
		this.itid = itid;
