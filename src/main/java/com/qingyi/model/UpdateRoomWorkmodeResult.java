...
public class UpdateRoomWorkmodeResult {
	...
	public UpdateRoomWorkmodeResult() {
		super();
	}
	public UpdateRoomWorkmodeResult(String orderid, Integer resultstatus, Integer filetype, Integer locklca,
			...
			String lockver, Integer lockcharge, Integer no, String order, String result, String space, String oscontent,
