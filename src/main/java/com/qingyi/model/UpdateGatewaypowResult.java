...
public class UpdateGatewaypowResult {
	...
	public UpdateGatewaypowResult() {
		super();
	}
	public UpdateGatewaypowResult(String orderid, Integer resultstatus, Integer filetype, Integer recordnum,
			String version, String beforever, String powerlev, String xindaoID, Integer xindao, Integer locknum,
			String locks, String wid, Integer no, String begin, String result, String space, String osdate) {
		super();
